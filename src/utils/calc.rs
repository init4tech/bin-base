...
mod tests {
    ...
    fn test_holesky_slot_window() {
        ...
        assert_eq!(
            calculator.calculate_slot_window(2),
            (1695902412, 1695902424)
        );
        assert_eq!(
            calculator.calculate_slot_window(3),
            (1695902424, 1695902436)
        );
    }
    ...
    fn test_ethereum_slot_window() {
        ...
        // calculate slot window
        assert_eq!(
            calculator.calculate_slot_window(4700013),
            (1663224167, 1663224179)
        );
        assert_eq!(
            calculator.calculate_slot_window(4700014),
            (1663224179, 1663224191)
        );
    }
}
